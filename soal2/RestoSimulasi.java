...
class Resto {
    ...
    // SOLUSI: Menambahkan keyword 'synchronized' pada deklarasi method
    // agar hanya ada satu thread yang bisa mengeksekusi method ini pada satu waktu.
...
public class RestoSimulasi {
    public static void main(String[] args) throws InterruptedException {
        ...
        // Memperbaiki penulisan lambda expression agar valid secara sintaks Java
        Runnable task = () -> {
            for (int i = 0; i < 40; i++) {
